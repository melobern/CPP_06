...
class ScalarConverter {
 ...
 private:
  ...
  bool        isChar(std::string const &str, Scalar &scalar) const;
  bool        isInt(std::string const &str, Scalar &scalar) const;
  bool        isFloat(std::string const &str, Scalar &scalar) const;
  bool        isDouble(std::string const &str, Scalar &scalar) const;
};
